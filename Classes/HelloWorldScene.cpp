...
bool HelloWorld::init()
{
	...
	CCSprite *map = CCSprite::create( "Fishfam_base_TH8.jpg" );
	map->setOpacity( 150 );
	...
	pzLayer->setScale( 2.0 );

	pzLayer->addChild( map, -1 );
	//map->setPosition( pzLayer->getContentSize() * 0.5 );

	CCSprite *mark = CCSprite::create( "HelloWorld.png" );
	map->addChild( mark );
	mark->setPosition( map->getContentSize() * 0.5 );
